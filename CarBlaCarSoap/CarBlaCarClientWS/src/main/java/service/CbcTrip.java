...
public class CbcTrip {
    ...
    public void findTripByDriver(DriverInfo driverInfo){
        Driver driver = new Driver();
        driver.setExperience(driverInfo.getExperience());
        driver.setRating(driverInfo.getRating());
        driver.setUser(driverInfo.getUser());
        ...
        tripService.findByDriver(driver);
    }
}
