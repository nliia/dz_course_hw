...
public interface TripsService {
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "findByDriver", targetNamespace = "http://service.itis.kpfu.ru/", className = "cxf.FindByDriver")
    @WebMethod
    @ResponseWrapper(localName = "findByDriver", targetNamespace = "http://service.itis.kpfu.ru/", className = "cxf.FindByDriver")
    public java.util.List<cxf.Trip> findByDriver(@WebParam(name = "arg0", targetNamespace = "")
                                                         cxf.Driver arg0);
}
